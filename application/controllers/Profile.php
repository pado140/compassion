...
class Profile extends My_Controller {
    ...
    public function index() {
        ...
        $this->layout->title($this->lang->line('my_profile') . ' | ' . CH);
    ...
    public function update() {
        ...
        if ($_POST) {
            ...
            if ($this->input->post('user_type') == 'children') {
                $data = $this->_get_posted_data();
                $updated = $this->profile->update('enfants', $data, array('id' => $this->input->post('id')));
            }
        }
