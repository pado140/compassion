                            ...
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paypal_extra_charge" value="<?php echo isset($setting) ? $setting->paypal_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('paypal'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="number">
                            ...
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="payu_extra_charge" value="<?php echo isset($setting) ? $setting->payu_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('payumoney'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="number">
                        ...
                        <div class="tab-pane fade in <?php echo isset($paytm) ? 'active':''; ?>" id="tab_paytm_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paytm_extra_charge" value="<?php echo isset($setting) ? $setting->paytm_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="number">
                         ...
                         <div class="tab-pane fade in <?php echo isset($paystack) ? 'active':''; ?>" id="tab_paystack_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stack_extra_charge" id="stack_extra_charge" value="<?php echo isset($setting) ? $setting->stack_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('pay_stack'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="number" autocomplete="off">
