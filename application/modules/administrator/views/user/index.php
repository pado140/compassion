                                ...
                                <tbody id="fn_mark">   
                                    ...
                                    if (isset($users) && !empty($users)) {
                                        ...
                                        <?php foreach ($users as $obj) { ?>
                                            ...
                                            $path = '';
                                            $type = '';
                                            if($role_id == CHILDREN){ $path = 'child'; $type = 'student'; }
                                            elseif($role_id == LIBRARIAN){ $path = 'guardian'; $type = 'guardian';  }
                                            elseif($role_id == MONITOR){ $path = 'teacher'; $type = 'teacher';  }
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucfirst($obj->nom ); ?></td>
