                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('children'); ?></th>
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($issue_books) && !empty($issue_books)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->nom.' '.$obj->prenom; ?></td>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="library_member_id" id="library_member_id" required="required">
                                            ...
                                            <?php foreach($members as $obj){ ?>
                                                <option value="<?php echo $obj->lm_id; ?>"><?php echo $obj->nom.' '.$obj->prenom; ?> [<?php echo $obj->custom_member_id; ?>]</option>
                                            <?php } ?>
                                        </select>
