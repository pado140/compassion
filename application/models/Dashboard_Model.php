...
class Dashboard_Model extends MY_Model {
    ...
    public function get_total_children(){
       ...
       $this->db->select('COUNT(*) AS total_children');
       $this->db->from('enfants');
       return $this->db->get()->row()->total_children;  
       
    }
    public function get_total_moniter(){
    ...
    public function get_total_book_read(){
    ...
    public function get_total_emprunt(){
    ...
    public function get_total_deliver(){      
