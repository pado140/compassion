...
if (!function_exists('get_template_tags')) {
    ...
    function get_template_tags($role_id) {
        ...
        } else if ($role_id == MONITER) {
            $tags[] = '[responsibility]';
            $tags[] = '[profession]';
            $tags[] = '[joining_date]';
        } else if ($role_id == LIBRARIN) {
            $tags[] = '[responsibility]';
            $tags[] = '[blood_group]';
            $tags[] = '[religion]';
            $tags[] = '[joining_date]';
...
if (!function_exists('xx_get_student_access_data')) {
 ...
 function xx_get_student_access_data($type = NULL){
        ...
        $ci = & get_instance();
         if($ci->session->userdata('role_id') != CHILDREN){
             return FALSE;
         }
